          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p>
                ...
                Statut juridique : Société à responsabilité limitée (SARL)<br />
                Capital social : 10 000 €<br />
                SIREN : 939 758 835<br />
                SIRET : 939 758 835 00010<br />
                Numéro de TVA intracommunautaire : En cours d'attribution<br />
                Adresse du siège social : 107 CHEMIN DU PLAN 1, 83550 VIDAUBAN<br />
            ...
            <section className="mb-8">
              ...
              <p>
                La société CHAUFFE O EXPRESS a été créée le 29 octobre 2024.<br />
                Activité principale de l'établissement (NAF/APE) : Activités des sièges sociaux (70.10Z)
              </p>
            </section>
