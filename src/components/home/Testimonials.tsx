...
const Testimonials = () => {
  ...
  return (
    <section
      id="temoignages"
      className="section-padding bg-gradient-to-b from-gray-light to-white"
    >
      <div className="container mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            ...
            témoignages de personnes qui ont fait confiance à nos services.
          </p>
        </div>
                ...
                <div key={testimonial.id} className="min-w-full p-4">
                  <div className="bg-white rounded-xl shadow-lg p-8">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="font-bold text-lg text-blue-dark">
                          {testimonial.name}
                        </h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center gap-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-xl font-bold text-blue-dark">
                    4.9/5
                  </span>
                </div>
              </div>
            ...
            <div>
              <p className="text-gray-600 text-center md:text-left">
                Basé sur{" "}
                <span className="font-bold text-blue-dark">27 avis</span> de nos
                clients satisfaits
              </p>
              <div className="mt-2">
                <a
